<template>
  <Transition name="modal">
    <div v-if="officer" class="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div class="
        bg-gray-900
...
// Load available Ollama models when modal opens
...
async function pingOfficer() {
  pinging.value = true
  try {
    await axios.post(`/api/fleet-officer/officers/${props.officer.officerId}/ping`)
