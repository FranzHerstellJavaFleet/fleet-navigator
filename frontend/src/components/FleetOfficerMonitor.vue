<template>
  <div class="fleet-officer-monitor space-y-4">
    <!-- Fleet Officers List -->
    ...
    ">
      ...
      <div class="text-xs text-gray-500">
        Fleet Officers sammeln Hardware-Daten von Remote-Systemen
      </div>
    </div>
    ...
    <div v-for="officer in officers" :key="officer.officerId" class="space-y-4">
      ...
      ">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-lg font-bold text-white">{{ officer.name }}</h3>
      ...
      <!-- Hardware Stats -->
      <div v-if="officerStats[officer.officerId]" class="space-y-4">
        <OfficerHardwareCard :stats="officerStats[officer.officerId]" />
      </div>
...
import OfficerHardwareCard from './OfficerHardwareCard.vue'
