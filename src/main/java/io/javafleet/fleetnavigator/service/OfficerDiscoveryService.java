...
/**
 * Service für Fleet Officer Discovery via UDP Broadcast
 */
@Service
public class OfficerDiscoveryService {

    private static final Logger log = LoggerFactory.getLogger(OfficerDiscoveryService.class);
    private static final int DISCOVERY_PORT = 9090;
    private static final String DISCOVERY_MESSAGE = "FLEET_NAVIGATOR_READY";

    /**
     * Sendet UDP Broadcast an alle Officers im Netzwerk
     * Officers im Listener Mode werden dadurch aufgeweckt und versuchen Reconnect
     */
    public void broadcastDiscovery() {
        try (DatagramSocket socket = new DatagramSocket()) {
            ...
            // 1. Sende an localhost (für lokale Officers)
            try {
